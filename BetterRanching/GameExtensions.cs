...
namespace BetterRanching
{
    public static class GameExtensions
    {
        ...
        public static bool ShouldOverride(bool ignoreClick = false)
        {
            return (Game1.player.CurrentTool?.Name == GameConstants.Tools.MilkPail || Game1.player.CurrentTool?.Name == GameConstants.Tools.Shears)
                && Game1.activeClickableMenu == null && (ignoreClick || IsClickableArea(Game1.getMousePosition()));
        }

        private static bool IsClickableArea(Point newPosition)
        {
